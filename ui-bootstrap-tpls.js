...
angular.module("template/datepicker/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/day.html",
    ...
    "    <thead>\n" +
    "    <tr>\n" +
    "        <th><button type=\"button\" class=\"btn btn-default btn-sm pull-left\" ng-click=\"move(-1)\" tabindex=\"-1\"><i class=\"glyphicon\" ng-class=\"{'glyphicon-chevron-left': !rtl, 'glyphicon-chevron-right': rtl }\"></i></button></th><!-- -->\n" +
